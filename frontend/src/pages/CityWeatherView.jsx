    ...
    const getWeatherDataById = (id) => {
        const weatherDatabase = {
            1: {
                ...
                icon: <img src="/public/assets/Few Clouds.png" alt="Few Clouds" className="w-16 h-16" />,
                tempMin: '25°C',
                tempMax: '28°C',
            ...
            2: {
                ...
                icon: <img src="/public/assets/BrokenClouds.png" alt="Broken Clouds" className="w-16 h-16" />,
                tempMin: '7°C',
                tempMax: '7°C',
            ...
            3: {
                ...
                temp: '-2°C',
                condition: 'Clear Sky',
                icon: <img src="/public/assets/ClearSky.png" alt="Clear Sky" className="w-16 h-16" />,
                tempMin: '2°C',
                tempMax: '5°C',
            ...
            4: {
                ...
                icon: <img src="/public/assets/LightRain.png" alt="Light Rain" className="w-16 h-16" />,
                tempMin: '30°C',
                tempMax: '30°C',
            ...
            5: {
                ...
                temp: '13°C',
                condition: 'Mist',
                icon: <img src="/public/assets/Mist.png" alt="Mist" className="w-16 h-16" />,
                tempMin: '10°C',
                tempMax: '15°C',
            ...
            6: {
                ...
                temp: '5°C',
                condition: 'Snow',
                icon: <img src="/public/assets/snow.png" alt="Snow" className="w-16 h-16" />,
                tempMin: '3°C',
                tempMax: '7°C',
            ...
            7: {
                ...
                icon: <img src="/public/assets/Thunderstorm.png" alt="Thunderstorm" className="w-16 h-16" />,
                tempMin: '26°C',
                tempMax: '30°C',
