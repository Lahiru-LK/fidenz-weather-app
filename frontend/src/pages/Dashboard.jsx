  ...
  const [weatherData, setWeatherData] = useState([
    {
      ...
      icon: <img src="/assets/Few Clouds.png" alt="Few Clouds" className="w-12 h-12" />,
      tempMin: '25°C',
      tempMax: '28°C',
    ...
    },
    {
      ...
      icon: <img src="/assets/BrokenClouds.png" alt="Broken Clouds" className="w-12 h-12" />,
      tempMin: '7°C',
      tempMax: '7°C',
    ...
    },
    {
      ...
      temp: '-2°C',
      condition: 'Clear Sky',
      icon: <img src="/assets/ClearSky.png" alt="Clear Sky" className="w-12 h-12" />,
      tempMin: '2°C',
      tempMax: '5°C',
    ...
    },
    {
      ...
      icon: <img src="/assets/LightRain.png" alt="Light Rain" className="w-12 h-12" />,
      tempMin: '30°C',
      tempMax: '30°C',
    ...
    },
    {
      ...
      temp: '13°C',
      condition: 'Mist',
      icon: <img src="/assets/Mist.png" alt="Mist" className="w-12 h-12" />,
      tempMin: '10°C',
      tempMax: '15°C',
    ...
    },
    {
      ...
      temp: '5°C',
      condition: 'Snow',
      icon: <img src="/assets/snow.png" alt="Snow" className="w-12 h-12" />,
      tempMin: '3°C',
      tempMax: '7°C',
    ...
    },
    {
      ...
      icon: <img src="/assets/Thunderstorm.png" alt="Thunderstorm" className="w-12 h-12" />,
      tempMin: '26°C',
      tempMax: '30°C',
